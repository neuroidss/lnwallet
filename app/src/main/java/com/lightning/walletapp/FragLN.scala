...
import com.lightning.walletapp.helper._
...
import com.lightning.walletapp.R.drawable.{await, conf1ln, dead, frozen}
import android.support.v4.app.LoaderManager.LoaderCallbacks
import com.lightning.walletapp.ln.PaymentRequest.write
