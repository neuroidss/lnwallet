...
class LNOpenHelper(context: Context, name: String)
  ...
  def onCreate(dbs: SQLiteDatabase) = {
    ...
    val dev1: Array[AnyRef] = Array("server-1", "https://a.lightning-wallet.com:9003", emptyData, "1", ord1, "0")
    val dev2: Array[AnyRef] = Array("server-2", "https://b.lightning-wallet.com:9003", emptyData, "0", ord2, "1")
